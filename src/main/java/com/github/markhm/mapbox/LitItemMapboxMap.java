 ...
 *
 */
public class LitItemMapboxMap extends LitMapboxMap
{
    public LitItemMapboxMap(String accessToken)
    {
        super(accessToken);
    }

    public LitItemMapboxMap(String accessToken, GeoLocation initialLocation)
    {
        super(accessToken, initialLocation);
    }

    public LitItemMapboxMap(String accessToken, GeoLocation initialLocation, int initialZoom)
    {
