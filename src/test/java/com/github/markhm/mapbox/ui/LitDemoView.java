...
@Route("lit")
public class LitDemoView extends VerticalLayout
{
    // http://www.jsonschema2pojo.org/

    private static Log log = LogFactory.getLog(LitDemoView.class);

    private static final String LEADING_WIDTH = "125px";

    private LitItemMapboxMap mapboxMap = null;
    ...
    private void render()
    {
        ...
        mapboxMap = new LitItemMapboxMap(accessToken, GeoLocation.InitialView_Turku_NY, 2);
